 ...
 */
#ifndef __PM_DATASET_SYNTAX_FUNCTION_HPP
#define __PM_DATASET_SYNTAX_FUNCTION_HPP

#include <utility>
#include "pm/type_abuse/sptr.hpp"
#include "pm/dataset/syntax/function_interface.hpp"
...
public:
  ...
  // PRESERVING METHODS
  inline dataset::Function interpret(Set & s) const override;
...
dataset::Function Function::interpret(Set & s) const {return ptr_->interpret(s);}
