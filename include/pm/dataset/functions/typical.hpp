 ...
 */
#ifndef __PM_DATASET_FUNCTIONS_TYPICAL_HPP
#define __PM_DATASET_FUNCTIONS_TYPICAL_HPP
...
Function set(size_t target, Args && ... args) {return dfun(type_abuse::funs::set<NewStoredValue>(std::forward<Args>(args) ...), target);}
